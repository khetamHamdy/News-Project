...
include 'header.php'; 
include 'config.php';
$query="SELECT * FROM `posts`  JOIN `category`  ON  posts.id_category =category.category_id where category.CATEGORYNAME ='POLITICS'";
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class="inner-content clearfix">
                                    ...
                                    <a class="read-more" href="single.php?id=<?php echo $fetch['id'] ;?>">read
                                        more</a>
                                </div>
                            </div>
                        </div>
